package com.fh.controller.casereal;
 ...
 */
@Controller
@RequestMapping(value="/casereal")
public class CaseRealController extends BaseController {
	
	String menuUrl = "casereal/list.do"; //菜单地址(权限用)
	@Resource(name="caseRealService")
	private CaseRealService caseRealService;
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("casereal/aggztj_dq_3/aggztj_dq_3_edit");
	...
	public ModelAndView goEdit(){
		...
		pd = this.getPageData();
		try {
			pd = caseRealService.findById(pd);	//根据ID读取
			mv.setViewName("casereal/aggztj_dq_3/aggztj_dq_3_edit");
