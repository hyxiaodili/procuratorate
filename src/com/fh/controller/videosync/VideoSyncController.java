package com.fh.controller.videosync;
...
public class VideoSyncController extends BaseController {
	
	String menuUrl = "videosync/list.do"; //菜单地址(权限用)
	@Resource(name="videoSyncService")
