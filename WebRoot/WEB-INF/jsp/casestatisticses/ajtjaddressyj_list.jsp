...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="casestatisticses/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td> --%>
										<td>${var.DWMC}</td>
										<td>
											<a href="<%=basePath%>casestatisticses/listbyCountEJ?DWBM=${var.DWBM}&beginTime=${pd.beginTime}&endTime=${pd.endTime}">${var.AJSL_ZDYSJ}</a>
										</td>
										<td>
											<a href="<%=basePath%>casestatisticses/listbyConcludeEJ?DWBM=${var.DWBM}&beginTime=${pd.beginTime}&endTime=${pd.endTime}">${var.AJBJ_ZDYSJ}</a>
										</td>
