						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td> --%>
										<td>${var.DWMC}</td>
										<td>
											<a href="<%=basePath%>casestatisticses/listbyCount?DWBM=${var.DWBM}&beginTime=${pd.beginTime}&endTime=${pd.endTime}">${var.AJSL_ZDYSJ}</a>
										</td>
										<td>
											<a href="<%=basePath%>casestatisticses/listbyConclude?DWBM=${var.DWBM}&beginTime=${pd.beginTime}&endTime=${pd.endTime}">${var.AJBJ_ZDYSJ}</a>
										</td>
