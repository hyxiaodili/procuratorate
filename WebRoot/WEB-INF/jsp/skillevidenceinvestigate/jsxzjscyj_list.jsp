...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="aggztj_dq_3/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">审查同意意见书（份）</th>
						<th class="center">审查不同意意见书（份）</th>
						<th class="center">审查其他意见书（份）</th>
						<th class="center">采纳审查意见（次）</th>
						<th class="center">未采纳审查意见（次）</th>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td> --%>
										<td>
											<a href="<%=basePath%>skillevidenceinvestigate/listbySkillevidenceinvestigateEJ?DWBM=${var.DWBM}&beginTime=${pd.beginTime}&endTime=${pd.endTime}&DWMC=${var.DWMC}">${var.DWMC}</a>
										</td>
										<td>${var.SCTYYJSA_JCJS1305_ZDYSJ}</td>
										<td>${var.SCBTYYJS_JCJS1305_ZDYSJ}</td>
										<td>${var.SCQTYJSA_JCJS1305_ZDYSJ}</td>
										<td>${var.CNSCYJAA_JCJS1305_ZDYSJ}</td>
										<td>${var.WCNSCYJA_JCJS1305_ZDYSJ}</td>
