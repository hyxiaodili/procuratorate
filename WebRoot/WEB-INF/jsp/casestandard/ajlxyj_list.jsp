...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="casestandard/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
					...
					<td style="vertical-align:top;"><button class="btn btn-danger btn-small" onclick="javascript:history.back(1);"  title="后退"><i id="nav-search-icon" class="icon-reply icon-2x icon-only"></i></button></td>
				</tr>
			</table>
			<!-- 检索  -->
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">检验鉴定</th>
						<th class="center">技术性证据审查</th>
						<th class="center">检察建议(技术)</th>
						<th class="center">事项议题提请(技术)</th>
					</tr>
				</thead>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								<%-- <td class='center' style="width: 30px;">
									<label><input type='checkbox' name='ids' value="${var.DWBM}" /><span class="lbl"></span></label>
								</td>
								<td class='center' style="width: 30px;">${vs.index+1}</td> --%>
								<td>
									<a href="<%=basePath%>casestandard/listbyidCasetypeEJ?DWBM=${var.DWBM}&beginTime=${pd.beginTime}&endTime=${pd.endTime}&DWMC=${var.DWMC}">${var.DWMC}</a>
								</td>
