						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td> --%>
										<td>${var.DWMC}</td>
										<td>
											<a href="<%=basePath%>deportation/listbySendthecase?YHSL_ID=${var.AGGZTJ_DQ_3_ID}">${var.SAJL_JCJS}</a>
										</td>
										<td>
											<a href="<%=basePath%>deportation/listbyDocumenttransfer?YHSL_ID=${var.AGGZTJ_DQ_3_ID}">${var.WSYSJL_JCJS}</a>
										</td>
