...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="configureabnormal/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">受理编号</th>
						<th class="center">受理名称</th>
						<th class="center">受理类别</th>
						<th class="center">受理位置</th>
						<th class="center">分配位置</th>
						<th class="center">是否手动分流</th>
						<th class="center">是否手动分配</th>
						<th class="center">流程模板名称</th>
						<th class="center">流程处理方式</th>
						<th class="center">流程处理情况</th>
						<th class="center">分流方式</th>
						<th class="center">是否自动确定承办人</th>
						<th class="center">自动确定承办人时间</th>
