  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<table>
				<tr>
					<th>
						<a href="<%=basePath%>configureabnormal/listbySecondlevel">标准二级院受理向导</a>
					</th>
					<th></th>
					<th></th>
					<th>
						<a href="<%=basePath%>configureabnormal/listbyThreelevel">标准三级院受理向导</a>
					</th>
					<th></th>
					<th></th>
					<th>
						<a href="<%=basePath%>configureabnormal/listbyFourlevel">标准四级院受理向导</a>
					</th>
				</tr>
			</table>
			<!-- 顶部超链接 -->
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">单位要号</th>
						<th class="center">案件要号</th>
