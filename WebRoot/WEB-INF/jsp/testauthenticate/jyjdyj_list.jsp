...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="testauthenticate/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">鉴定书（份）</th>
						<th class="center">检验报告（份）</th>
						<th class="center">鉴定人出庭（次）</th>
						<th class="center">法庭采纳（次）</th>
						<th class="center">撤销鉴定意见（次）</th>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td> --%>
										<td>
											<a href="<%=basePath%>testauthenticate/listbyTestauthenticateEJ?DWBM=${var.DWBM}&beginTime=${pd.beginTime}&endTime=${pd.endTime}&DWMC=${var.DWMC}">${var.DWMC}</a>
										</td>
										<td>${var.JDSAAA_JCJS1304_ZDYSJ}</td>
										<td>${var.JYBGAA_JCJS1304_ZDYSJ}</td>
										<td>${var.JDRCTA_JCJS1304_ZDYSJ}</td>
										<td>${var.FTCNAA_JCJS1304_ZDYSJ}</td>
										<td>${var.CXJDYJ_JCJS1304_ZDYSJ}</td>
