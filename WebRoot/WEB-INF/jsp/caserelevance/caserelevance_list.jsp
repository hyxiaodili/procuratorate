...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			<!-- 检索  -->
			<form action="caserelevance/listByDcn" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
					...
					<td>
						<span class="input-icon">
							<input autocomplete="off" id="nav-search-input" type="text" name="f2" value="" placeholder="这里输入部门受案号" />
							<i id="nav-search-icon" class="icon-search"></i>
						</span>
					</td>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">源案件</th>
						<th class="center">关联案件</th>
					</tr>
				</thead>
				...
				<c:choose>
					<c:when test="${not empty varList}">
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
										<td>
											<a href="<%=basePath%>caserelevance/listbyUnitname?DWBM=${var.DWBM}&DWMC=${var.DWMC}">${var.DWMC}</a>
										</td>
										<td>
											<a href="<%=basePath%>caserelevance/listbySourcecase?DWBM=${var.DWBM}">${var.SAAJGL_JCJS}</a>
										</td>
										<td>
											<a href="<%=basePath%>caserelevance/listbyRelevancecase?DWBM=${var.DWBM}">${var.TAAJGL_JCJS}</a>
										</td>
							</tr>
