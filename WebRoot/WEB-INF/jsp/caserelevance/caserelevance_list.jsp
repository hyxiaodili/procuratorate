						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td> --%>
										<td>${var.DWMC}</td>
										<td>
											<a href="<%=basePath%>caserelevance/listbySourcecase?YHSL_ID=${var.AGGZTJ_DQ_3_ID}">${var.SAAJGL_JCJS}</a>
										</td>
										<td>
											<a href="<%=basePath%>caserelevance/listbyRelevancecase?YHSL_ID=${var.AGGZTJ_DQ_3_ID}">${var.TAAJGL_JCJS}</a>
										</td>
