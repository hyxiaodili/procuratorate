...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="departmentreal/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										<td>${var.DWMC}</td>
										<td>${var.WTBM04_JCJS_TYSAH}</td>
										<td>${var.WTBM05_JCJS_TYSAH}</td>
										<td>${var.WTBM02_JCJS_TYSAH}</td>
										<td>${var.WTBM03_JCJS_TYSAH}</td>
										<td>${var.WTBM06_JCJS_TYSAH}</td>
										<td>${var.WTBM07_JCJS_TYSAH}</td>
										<td>${var.WTBM08_JCJS_TYSAH}</td>
										<td>${var.WTBM09_JCJS_TYSAH}</td>
										<td>${var.WTBM10_JCJS_TYSAH}</td>
										<td>${var.WTBM11_JCJS_TYSAH}</td>
										<td>${var.WTBM14_JCJS_TYSAH}</td>
										<td>${var.WTBM01_JCJS_TYSAH}</td>
										<td>${var.WTBM13_JCJS_TYSAH}</td>
										<td>${var.WTBM12_JCJS_TYSAH}</td>
										<td>${var.WTBM30_JCJS_TYSAH}</td>
										<td>${var.WTBM21_JCJS_TYSAH}</td>
										<td>${var.WTBM22_JCJS_TYSAH}</td>
										<td>${var.WTBM23_JCJS_TYSAH}</td>
										<td>${var.WTBM24_JCJS_TYSAH}</td>
							</tr>
