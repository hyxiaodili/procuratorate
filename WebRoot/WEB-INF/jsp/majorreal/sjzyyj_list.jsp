...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="majorreal/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">法医临床</th>
						<th class="center">法医病理</th>
						<th class="center">法医精神病</th>
						<th class="center">法医物证(DNA)</th>
						<th class="center">法医毒物</th>
						<th class="center">文件检验</th>
						<th class="center">痕迹检验</th>
						<th class="center">微量物证</th>
						<th class="center">声像资料(视听技术)</th>
						<th class="center">电子证据</th>
						<th class="center">司法会计</th>
						<th class="center">心理测试</th>
						<th class="center">同步录音录像</th>
						<th class="center">评估</th>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td> --%>
										<td>
											<a href="<%=basePath%>majorreal/listbyInvolvemajorEJ?DWBM=${var.DWBM}&beginTime=${pd.beginTime}&endTime=${pd.endTime}&DWMC=${var.DWMC}">${var.DWMC}</a>
										</td>
										<td>${var.FYLC_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.FYBL_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.FYJS_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.FYWZ_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.FYDW_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.WJJY_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.HJJY_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.WLWZ_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.SXZL_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.DZZJ_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.SFKJ_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.XLCS_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.TBLX_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.PG_JCJS_TYSAH_ZDYSJ}</td>
										<td>${var.QT_JCJS_TYSAH_ZDYSJ}</td>
							</tr>
