...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			<!-- 检索  -->
			<form action="writmountnode/searching" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
						<span class="input-icon">
							<input autocomplete="off" id="nav-search-input" type="text" name="field1" placeholder="这里输入关键词" />
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">文书模板编号</th>
						<th class="center">文书模板名称</th>
						<th class="center">流程模板名称</th>
				...
				<c:choose>
					...
					<c:otherwise>
						<tr class="main_info">
							<td colspan="100" class="center" >请输入文书名称</td>
						</tr>
					</c:otherwise>
				</c:choose>
