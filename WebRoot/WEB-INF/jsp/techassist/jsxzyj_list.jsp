...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="techassist/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">提取物证(份)</th>
						<th class="center">物证照相录像(次)</th>
						<th class="center">提供物证录像(份)</th>
						<th class="center">提供物证照片(份)</th>
						<th class="center">提供其他视听资料(份)</th>
						<th class="center">工作说明(份)</th>
					</tr>
				</thead>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td> --%>
										<td>
											<a href="<%=basePath%>techassist/listbyTechassistEJ?DWBM=${var.DWBM}&beginTime=${pd.beginTime}&endTime=${pd.endTime}&DWMC=${var.DWMC}">${var.DWMC}</a>
										</td>
										<td>${var.TQWZAAAA_JCJS1302_ZDYSJ}</td>
										<td>${var.WZZXLXAA_JCJS1302_ZDYSJ}</td>
										<td>${var.TGWZLXAA_JCJS1302_ZDYSJ}</td>
										<td>${var.TGWZZPAA_JCJS1302_ZDYSJ}</td>
										<td>${var.TQQTSTZL_JCJS1302_ZDYSJ}</td>
										<td>${var.GZSMAAAA_JCJS1302_ZDYSJ}</td>
							</tr>
