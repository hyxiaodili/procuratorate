...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="checkcase/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">勘验笔录(份)</th>
						<th class="center">侦查实验笔录(份)</th>
						<th class="center">其它文书材料(份)</th>
					</tr>
				</thead>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td> --%>
										...
										<td>${var.TGWZLXAA_JCJS1301_ZDYSJ}</td>
										<td>${var.TGWZZPAA_JCJS1301_ZDYSJ}</td>
										<td>${var.TQQTSTZL_JCJS1301_ZDYSJ}</td>
										<td>${var.KYBLAAAA_JCJS1301_ZDYSJ}</td>
										<td>${var.ZCSYBLAA_JCJS1301_ZDYSJ}</td>
										<td>${var.QTWSCLAA_JCJS1301_ZDYSJ}</td>
							</tr>
