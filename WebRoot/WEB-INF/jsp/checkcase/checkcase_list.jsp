						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										<td>${var.DWMC}</td>
										<td>${var.TQWZ_JCJS1301}</td>
										<td>${var.WZZXLX_JCJS1301}</td>
										<td>${var.TGWZLX_JCJS1301}</td>
										<td>${var.TGWZZP_JCJS1301}</td>
										<td>${var.TQQTSTZL_JCJS1301}</td>
										<td>${var.KYBL_JCJS1301}</td>
										<td>${var.ZCSYBL_JCJS1301}</td>
										<td>${var.QTWSCL_JCJS1301}</td>
							</tr>
